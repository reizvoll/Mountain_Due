...
const Comments = () => {
  ...
  const { comments, createMutation, updateMutation, deleteMutation } =
    useComments(spotId)
    ...
    <div className="flex flex-col gap-4 pt-10">
      ...
      <div className="flex flex-col gap-4">
        {comments?.map((comment) => (
          <div
            key={comment.id}
            className="flex flex-col gap-2 border border-gray-300 rounded-2xl p-4"
          >
            ...
            {updateValues.id === comment.id ? (
              ...
              <div className="flex justify-between items-center">
                <p className="text-base px-8 whitespace-pre-wrap">
                  {comment.content}
                </p>
