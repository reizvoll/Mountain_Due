...
- 지도 
![최종구현](https://github.com/user-attachments/assets/2afe56cf-daa6-4e4b-a911-d90730bfe9bb)

- 메인 페이지에서 사용자의 위치기반 혹은 광역시 6개의 실내 클라이밍장 정보를 확인할 수 있습니다.
- 카카오 Maps API 를 활용해, 제공해주는 기능들을 위주로 위치를 파악할 수 있게 구현하였습니다.
- 카카오 Maps API에서 제공해주는 페이지네이션을 통해 최대한 많은 정보를 확인할 수 있게 하였습니다.
